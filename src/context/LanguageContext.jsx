...
const translations = {
  ru: {
    ...
    collapse: 'Свернуть',
    guide: 'Управление',
    guideClickMap: 'Клик по карте - создать',
    guideClickMarker: 'Клик по метке - редактировать',
    guideCtrl: 'в группу',
    guideShiftMarker: 'по метке - траектория',
    guideShiftMap: 'по карте - конец',
    guideRightClick: 'Правая кнопка мыши - удалить',
    guideGroupClick: 'Клик по группе - развернуть',
  ...
  en: {
    ...
    collapse: 'Collapse',
    guide: 'Controls',
    guideClickMap: 'Click on map - create',
    guideClickMarker: 'Click on marker - edit',
    guideCtrl: 'add to group',
    guideShiftMarker: 'on marker - trajectory',
    guideShiftMap: 'on map - endpoint',
    guideRightClick: 'Right-click - delete',
    guideGroupClick: 'Click on group - expand',
